...
*/
class DllExport Sound : public Sensor{
  public:
    /**
    ...
    */
    Sound::Sound(Sensor_port port, Connection* connection, Sound_mode sound_mode=DBA_MODE):Sensor(port, connection, SOUND_DBA, PERCENT_MODE){
